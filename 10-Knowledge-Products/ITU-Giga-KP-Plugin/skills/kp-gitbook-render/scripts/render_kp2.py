...
INTERNAL = [
    ...
    (r"the decree \(Topic 2\)|the Topic-2 decree|Topic 2 decree", "module-2/README.md"),
    (r"member obligations \(Topic 3\)|the Governance Pack", "module-3/README.md"),
    (r"standards portfolio \(Topic 4\)", "module-4/4-3.md"),
    (r"the four-phase plan \(Topic 5\)", "module-5/5-1.md"),
    (r"kp-solution-verify|build-pack acceptance check", "build-pack/acceptance.md"),
    (r"Linkup federation", "build-pack/run.md"),
    (r"ToR §4\.\d", "README.md"),
    (r"KP2 deliverables|KP2 method end-to-end|KP2 AI plays", "README.md"),

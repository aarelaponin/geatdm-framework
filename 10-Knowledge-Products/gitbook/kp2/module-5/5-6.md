...
| **Anchor** | PAERA §5.2 Principle #5 (Once-Only); NIIS X-Road; the build-pack acceptance check |
...
- the build-pack acceptance check — on this site: [acceptance](../build-pack/acceptance.md)

---
description: "Prerequisites, the steps, verifying a change, joining a member, teardown."
icon: play
---
...
{% hint style="info" %}
**Copied from the build pack.** This page is `KP2-build-pack/runbook.md` as it stands in the pack, with a header; the pack is the source and this page is regenerated from it. Paths in backticks are relative to `KP2-build-pack/`.
{% endhint %}

---
description: "The pack's headline check: PNEA pre-fills identity from PNIA and enrolment from PLR; the learner is asked once; the unauthorised caller is denied."
icon: circle-check
---
...
{% hint style="info" %}
**Copied from the build pack.** This page is `KP2-build-pack/acceptance/once-only-exchange.md` as it stands in the pack, with a header; the pack is the source and this page is regenerated from it. Paths in backticks are relative to `KP2-build-pack/`.
{% endhint %}

...
| **Your play** | ✍️ Generate a semantic map for an exchange · *Drafting* · produces workbook artefact **B23** |
...
## Your turn — Generate a semantic map for an exchange
...
**What it does.** An architect needs a semantic map for one exchange — the entities, fields, code lists, identifier and the mapping onto published vocabularies — drafted from the two agencies' field lists. This is the semantic-map play.
...
**This artefact feeds:** [4.5 Generate an OpenAPI service contract](./4-5.md), [4.6 Map a real sector data source through bronze/silver/gold onto the bus](./4-6.md), [5.10 Map your framework's sector-portable vs sector-specific parts for a new sector](../module-5/5-10.md)

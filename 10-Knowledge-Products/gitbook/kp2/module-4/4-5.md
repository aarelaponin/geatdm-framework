...
| **Your play** | ✍️ Generate an OpenAPI service contract (gif-openapi-gen) · *Drafting* · produces workbook artefact **B24** |
...
## Do this on your own sector — Generate an OpenAPI service contract (gif-openapi-gen)
...
**What it does.** An architect needs an OpenAPI 3.x contract for a service, generated from the service brief and the semantic map, ready to derive an X-Road service description. This is the gif-openapi-gen play.

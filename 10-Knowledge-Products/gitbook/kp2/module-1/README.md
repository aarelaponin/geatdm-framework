---
description: "Seven videos for the Strategist making the case: why interoperability is built rather than bought, the four layers it fails at, the once-only promise it exists for."
icon: flag-checkered
---
...
flowchart TD
    ...
    B4["B4 Strategic Foundation Document\n(1.4)"]
    B5["B5 Use-Case Catalogue\n(1.5)"]
    B6["B6 Stakeholder tier map\n(1.6)"]
    B7["B7 Standards-to-reuse shortlist\n(1.7)"]
    M2out["Module 2"]
    M3out["Module 3"]
    M4out["Module 4"]
    M5out["Module 5"]

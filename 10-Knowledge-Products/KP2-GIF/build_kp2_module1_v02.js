...
body.push(...renderSubtopic({
  ...
  slideSpecRows: [
    ...
    ["2", "Four-layer stack. Four text rows bottom-to-top (Technical / Semantic / Organisational / Legal), one short gloss each.",
      "The spine of the whole topic. A plain stacked text diagram — text-box rows, no icons."],
    ...
    ["5", "Organisational layer slide. Three text rows: data-sharing agreements, service levels, a governing body.",
      "Sets up Topic 3 (governance). Text-only."],
    ["6", "Legal layer slide. Two text rows: the mandate; the cost of skipping it. 'The decree is the on-switch.'",
      "Sets up Topic 2 (the decree). The 'on-switch' line is the memorable beat."],
...
body.push(...renderSubtopic({
  ...
  slideSpecRows: [
    ...
    ["4", "Progressa once-only. Three text rows: the learner, the pre-fill from PNIA and PLR, asked once.",
      "Previews the Topic 5 demonstration. Uses the bound Progressa institutions."],
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 5 — Title: 'A bus needs an owner'. Body, single text block: 'None of this holds together without a body that governs the framework — admits members, sets service levels, resolves disputes. An interoperability platform with no owner decays in its second year. Governance is the next topic.'" },
  ...
  slideSpecRows: [
    ...
    ["3", "Provider-vs-consumer slide. Two text rows on the two sides and their different incentives.",
      "The interoperability-specific insight. Sets up fair service agreements (Topic 3/5)."],
    ...
    ["5", "Bus-needs-an-owner slide. Single text block previewing governance.",
      "Sets up Topic 3. The 'decays in its second year' line is the memorable beat."],
    ["6", "Single-sentence summary slide. One large text block (Arial Bold 28pt).",
      "The take-home line."],
    ["7", "Sources slide. Footer: 'Find the link in the description.'",

# NotebookLM setup for KP2 · M1 · Video 1.3

Deck `KP2_M1_1.3_Deck_v0.1.pptx` · brief `KP2_M1_1.3_AudioBrief_v0.1.md`
...
3. Add `KP2_M1_1.3_AudioBrief_v0.1.md` as the **only** source.
...
```
Follow the source titled "AUDIO BRIEF — Module 1 Video 1.3" exactly. It is the sole
...
Say "the reference architecture" in words; never say the initialism "PAERA" or any expansion of it. Say "Progressa" as pro-GRESS-a — never "Progressive", never "Progresa". Invent no figures, dates, countries or examples.
```

## Step 4 — Fallback if the box truncates

```
Follow the source "AUDIO BRIEF — Module 1 Video 1.3" exactly, working through its
...
python3 …/kp-audio-brief/scripts/srt_drift_check.py \
  videos/module_1/en/audio/KP2_M1_1.3_Audio_v0.X.srt --target 300 --tolerance 45
```

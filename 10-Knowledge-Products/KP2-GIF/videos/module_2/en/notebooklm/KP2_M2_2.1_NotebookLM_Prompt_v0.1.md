# NotebookLM setup for KP2 · M2 · Video 2.1

Deck `KP2_M2_2.1_Deck_v0.1.pptx` · brief `KP2_M2_2.1_AudioBrief_v0.1.md`
...
3. Add `KP2_M2_2.1_AudioBrief_v0.1.md` as the **only** source.
...
```
Follow the source titled "AUDIO BRIEF — Module 2 Video 2.1" exactly. It is the sole
...
```
Follow the source "AUDIO BRIEF — Module 2 Video 2.1" exactly, working through its
...
python3 …/kp-audio-brief/scripts/srt_drift_check.py \
  videos/module_2/en/audio/KP2_M2_2.1_Audio_v0.X.srt --target 300 --tolerance 45
```

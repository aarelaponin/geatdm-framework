# AUDIO BRIEF — Module 2 · Video 2.3
## "The Explanatory Memorandum and Preamble"
...
| Companion deck | `KP2_M2_2.3_Deck_v0.1.pptx` — 7 slides; the audio follows the slide order in §2 |
...
### Slide 1 — The Explanatory Memorandum and Preamble · 0:00–0:15 (15 s · ~0 words of substance)
...
### Slide 2 — The first two parts are the ones a non-lawyer can lead on. · 0:15–1:05 (50 s · ~86 words of substance)
...
- The first two parts are the ones a non-lawyer can lead on.
- They are about the case and the context, not the binding rules. Both start from the Strategic Foundation Document you already have.

### Slide 3 — The Memorandum is the case, written for the minister · 1:05–2:05 (60 s · ~103 words of substance)
**The substance. Every sentence the hosts say in this segment comes from these words — discuss them, do not depart from them:**
...
- 1. The problem the decree solves Fragmentation; the citizen asked the same thing many times.
- 2. What the decree does In plain language.
- 3. Why now The cost of another year without a mandate.
- 4. The expected benefit To citizens and to the state.
- Largely a translation of your Strategic Foundation Document.

### Slide 4 — The Preamble: every cited authority is a [confirm] · 2:05–3:10 (65 s · ~113 words of substance)
**The substance. Every sentence the hosts say in this segment comes from these words — discuss them, do not depart from them:**
...
- 1. The recitals The formal findings the decree rests on.
- 2. The legal authority The constitutional or statutory power to make this decree.
- 3. [confirm] on every citation Until a qualified lawyer verifies the power exists and supports this decree.
- A wrong authority citation is the fastest way to have the whole decree sent back.

### Slide 5 — Generate fast, confirm carefully · 3:10–4:20 (70 s · ~96 words of substance)
**The substance. Every sentence the hosts say in this segment comes from these words — discuss them, do not depart from them:**
...
- THE AI PLAY — NINETY PER CENT Turns the foundation document into a Memorandum draft and a Preamble scaffold. In minutes.
- YOU — THE ESSENTIAL TEN Confirm every legal citation against a real statute. Soften any claim the evidence does not support; mark the rest [confirm].
- The AI accelerates the drafting. It does not get the law right for you.

**Staging:** Production cue: the pivotal slide of this video — the pattern the rest of the kit repeats. Hold it a beat longer.

### Slide 6 — In one sentence · 4:20–4:50 (30 s · ~48 words of substance)

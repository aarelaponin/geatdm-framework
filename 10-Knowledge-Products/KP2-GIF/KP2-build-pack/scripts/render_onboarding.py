...
none of onboarding/<key>/'s four files render backend at all -- schema.py's
own addition is the only thing that reads it, and that is a join-
...
if not requirements_cfg:
    sys.exit(
        ...
        "member_requirements: block -- add it by hand before this "

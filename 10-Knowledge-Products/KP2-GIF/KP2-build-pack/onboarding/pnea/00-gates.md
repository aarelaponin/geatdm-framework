...
| SLA (5.3) | Signed SLA per published service | Operating Authority | **out of scope** -- nothing published; the SLA template is written for providers, and a consumer-only member has none |
...
| Admission (G1) | Minuted admission decision | Steering Committee | **named absence** -- not implemented in this demo |

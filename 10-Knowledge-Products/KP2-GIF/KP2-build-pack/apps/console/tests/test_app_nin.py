...
assumed: three of the six shapes named below never reach
...
not the 400 assumed without checking. The validator itself is
...
# All six shapes -- exercised directly against the
...
def test_identity_held_fields_rejects_bad_nin_directly():
    ...
    via get_exchange -- a deliberate double-check."""
    for nin in ALL_BAD_SHAPES:

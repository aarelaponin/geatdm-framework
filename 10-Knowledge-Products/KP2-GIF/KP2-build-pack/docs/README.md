...
**Reference** (this directory's root, plus `README.md`/`runbook.md`/`exercises.md`/`manifest.yaml`/`deployment.yaml`/`hurl/README.md`/`PLAN.md` at the pack root) — true right now: no history, no dates, no status tables.

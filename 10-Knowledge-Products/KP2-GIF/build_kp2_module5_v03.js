...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 5 — Title: 'Sources'. Body: the deliverables of this knowledge product — the decree (Topic 2), the Governance Pack (Topic 3), the standards portfolio (Topic 4); EU EIF. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [

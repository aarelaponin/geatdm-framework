...
| 5 | Implementation + member onboarding + the Linkup demo — and running the framework (5.8 bus monitoring, 5.9 document-consistency cross-check, 5.10 sector portability) | Architect (5.1–5.8), Strategist (5.9–5.10) | `build_kp2_module5_v04.js` | `KP2_Module5_Script_Bundle_v0.4.md` |
...
**All five KP2 modules authored and gated (Modules 1–4 v0.2, Module 5 v0.4) — KP2 complete in draft and aligned to the 08 source.** The build pack's three configuration layers are specified across the modules: legal (the decree, M2), organisational (the Governance Pack, M3), and technical (the semantic map + OpenAPI + X-Road service descriptions, M4); Module 5 stands them all up on the Linkup federation with the member registrations and proves them with the live once-only exchange (the `kp-solution-verify` acceptance check), then operates it (5.8 monitoring, 5.9 the document cross-check) and carries it to the next sector (5.10). The GitBook companion (`../gitbook/kp2/`) carries the AI-play catalogue, the four role-paths and the country storyboard that were Module 6. Module 5 v0.4 (13 September) carries the corrections in `KP2_M5_Script_vs_Pack_Review_2026-09-10.md` §2 items 1–5 and rebuilds 5.6 around demo evidence recorded from the running build pack (`KP2_M5_Theory_Demo_Video_Plan_2026-09-13.md`); item 6 (5.7) is still pending. Configs are filled during the M4–5 build with `bb-config-gen`. Open calibration items for ITU's Tuesday review are in each module's Section 5 and in `KP2_Plan_v0.1.md` §7 — notably the Progressa demo membership (four Security Servers: PDGA as the owner, PNEA, PLR, PNIA — MoEYS/PEMIS retired) and the re-phased schedule + Linkup cloud access (A4).

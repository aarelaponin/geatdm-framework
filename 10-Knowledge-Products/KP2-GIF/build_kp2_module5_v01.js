// Build KP2 Module 5 — Video Script Bundle v0.1
// Government Interoperability Framework · Topic 5 — Implementation, onboarding, and the live demonstration
...
// Persona for KP2 Module 5 (Architect throughout — implementation and the live demonstration)
...
body.push(
  ...
  new Paragraph({ spacing: { before: 0, after: 200 },
    children: [new TextRun({ text: "Topic 5 — Implementation, onboarding, and the live demonstration",
...
body.push(...renderSubtopic({
  ...
  singleMessage: "Core Platform, Pilot, Multi-agency, Optimisation — four phases with decision gates and a cost frame you can defend to a funder.",
  scriptBeats: [
    { cue: "Slide 1 — Title: 'Plan the build in four phases'. Voice-over begins." },
    { text: "You do not onboard a whole government at once. You build the framework in four phases, each delivering something real, each with a decision gate before the next is funded, and each with a cost you can put in front of a funder. The phasing is what keeps the programme alive in the long stretch between the launch enthusiasm and the mature federation — and it is drawn from how Estonia and others actually built their buses, not from a textbook." },
    ...
    { cue: "Slide 4 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'Four phases, four decision gates, a benchmarked cost frame at each — a build plan a funder can approve and a programme that survives its second year.'" },
    { text: "So you plan the build in four phases: Core Platform, Pilot, Multi-agency, Optimisation. Each delivers a real outcome, each ends with a gate, each carries a benchmarked cost frame. That is how you turn an interoperability framework from an ambition into a fundable, deliverable programme — one that pays for the shared platform once and reuses it across the whole of government." },
  ...
  slideSpecRows: [
    ...
    ["2", "Four-phases slide. Four text rows with phase, window and outcome.",
      "The implementation spine. Plain text rows, no icons."],
    ["3", "Each-phase-four-things slide. Four text rows: outcomes, gate, risks, cost frame.",
  ...
  aiTip: {
    title: "Draft your four-phase implementation plan with gates and cost frame",
    ...
    io: "Input: the first agencies/exchanges, any budget envelope and constraints. Output: a four-phase plan with outcomes, gates, risks and a cost frame.",
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 4 — Title: 'It is config, not paperwork'. Body, single text block: 'The subsystem and access-control list go straight into the build pack, under the member's folder. They are part of the runnable proving slice — what kp-solution-verify deploys and checks. Registering a member is executable configuration that puts an agency on the bus.'" },
    ...
    { cue: "Slide 5 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'The subsystem registration and the access-control list are the configuration that admits a member — generated, confirmed against the registry, and deployed.'" },
    ...
    { cue: "Slide 6 — Title: 'Sources'. Body: NIIS X-Road member and subsystem registration; access-control list configuration. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
    ...
    ["4", "It-is-config slide. Single text block on the build pack and kp-solution-verify.",
  ...
  aiTip: {
    ...
    io: "Input: the member's details, its services, and the access policy. Output: the subsystem registration and access-control list, with [confirm] placeholders and an onboarding checklist.",
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 5 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'A real cross-server call, the learner asked once — every layer proven in a single exchange, and the framework with it.'" },
...
const doc = new Document({
  ...
  title: "KP2 Module 5 — Video Script Bundle v0.1 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP2 Topic 5 Script Bundle v0.1 · 27 June 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP2_Module5_Script_Bundle_v0.1.docx");

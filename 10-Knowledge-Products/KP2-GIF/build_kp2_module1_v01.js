// Build KP2 Module 1 — Video Script Bundle v0.1
...
body.push(
  ...
  genericTable([700, 2700, 4700, 1600], ["#", "Title", "Single message", "Runtime"], [
    ["1.1", "Why interoperability can't be bought, only built",
      "Procurement rules can require interoperability. Only whole-of-government planning delivers it. That is why the answer is a framework, not a clause in a contract.", "~5 min"],
...
body.push(...renderSubtopic({
  ...
  singleMessage: "Procurement rules can require interoperability. Only whole-of-government planning delivers it. That is why the answer is a framework, not a clause in a contract.",
  scriptBeats: [
    ...
    { cue: "Slide 6 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'Procurement can require interoperability. Only a planned framework — legal, organisational, semantic, technical — can deliver it.'" },
    ...
    { cue: "Slide 7 — Title: 'Sources'. Body: EU European Interoperability Framework; NIIS X-Road (niis.org); PAERA v1.0 §3.4.3; §5.2. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 7 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'Interoperability is four layers — technical, semantic, organisational, legal. It fails at whichever one you skip.'" },
    { text: "So the discipline the framework gives you is simple to state and hard to skip. Interoperability is four layers — technical, semantic, organisational, legal. Most failed projects had a working technical layer and skipped one of the other three. The rest of this knowledge product builds all four for a real exchange, in order — and the reason we keep returning to the layers is that the framework's whole job is to make you address every one of them on purpose." },
    { cue: "Slide 8 — Title: 'Sources'. Body: EU European Interoperability Framework (four-layer model); NIIS X-Road documentation; PAERA v1.0 §3.4.3. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 2 — Title: 'What it answers'. Body, four text rows: 'Mandate — by whose authority does this framework exist?' 'Scope — which agencies and which exchanges are in, and which are not, yet?' 'Principles — the rules every design decision must honour.' 'Success — how we will know it is working.'" },
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 4 — Title: 'Who to work first'. Body, three text rows: 'Pair a Champion consumer with a willing provider — that is your first exchange.' 'Use the first win to move Early Adopters.' 'Bring Observers along with evidence, not argument.'" },
  ...
  slideSpecRows: [
    ...
    ["4", "Sequencing slide. Three text rows: first exchange, move Early Adopters, evidence for Observers.",
  ...
  aiTip: {
    ...
    io: "Input: a list of agencies with their data roles and attitudes. Output: a tier map, a provider/consumer table, and a recommended onboarding sequence.",
...
const doc = new Document({
  ...
  title: "KP2 Module 1 — Video Script Bundle v0.1 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP2 Topic 1 Script Bundle v0.1 · 27 June 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP2_Module1_Script_Bundle_v0.1.docx");

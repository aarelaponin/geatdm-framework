<!-- GENERATED from build_kp2_module2_v02.js by bundle_to_md.py — do not hand-edit; edit the build script and regenerate. -->

# KP2 Module 2 — Video Script Bundle v0.2 (ITU-aligned)
...
| 2.5 | The Cover Note and Two-Track Regulatory Memo | Transmit the package with a specific ask, and show how the decree and the data-protection law fit together — so the decree moves, and the data-protection authority backs it instead of blocking it. | ~5 min |
...
> _Slide 3 — Title: 'Each part has a different reader'. Body, three text rows: 'The minister reads the Memorandum.' 'The lawyer reads the Preamble and the Articles.' 'The data-protection authority reads the Two-Track Memo to see the two laws fit.'_
...
| --- | --- |
| Persona | S (Strategist) — national interoperability authority, ministry CIO, Ministry of Justice sponsor, or development-partner lead |
| Target runtime | ~5 min (≈660 spoken words) |
| PAERA anchor | Estonia Information Society Services Act; EU Once-Only Regulation; EU EIF underlying principles; PAERA §5.2 #5 (Once-Only); national data-protection framework |
...
| Persona | S (Strategist) — national interoperability authority, ministry CIO, Ministry of Justice sponsor, or development-partner lead |
| Target runtime | ~5 min (≈560 spoken words) |
| PAERA anchor | EU EIF (legal & governance layers); the country's personal-data-protection law and data-protection authority; national legislative-process references |

> **Single message —** _Transmit the package with a specific ask, and show how the decree and the data-protection law fit together — so the decree moves instead of sitting in a queue, and the data-protection authority backs it instead of blocking it._
...
> _Slide 2 — Title: 'The Cover Note'. Body, three text rows: 'What this package is, in three lines.' 'What is being asked — review the Articles, confirm the authorities, advise on the route: decree or primary legislation.' 'The timeline, and the cost of slipping it.'_
...
> _Slide 5 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'Transmit with a specific ask, and show the decree and the data-protection law as two coordinated tracks — so enactment is a decision, and the data-protection authority is a co-signer.'_
...
> _Slide 6 — Title: 'Sources'. Body: EU European Interoperability Framework (legal & governance layers); the country's personal-data-protection law and data-protection authority; national legislative-process references. Footer: 'Find the link in the description.'_
...
| 2 | Cover Note slide. Three text rows: what it is, the specific ask (incl. decree vs primary legislation), the timeline. | The transmittal structure. Text-only. |
| 3 | Two-tracks slide. Two-column text: the decree vs the data-protection law, three rows each, plus a footer row of meeting points. | The core comparison. Text columns, no icons. |
| 4 | Coordination slide. Single text block on the mechanisms that make the data-protection authority a co-signer. | The 'why this unsticks the queue' beat. |
| 5 | Single-sentence summary slide. One large text block (Arial Bold 28pt). | The take-home line. |
| 6 | Sources slide. Footer: 'Find the link in the description.' | Lets viewers verify the references. |

### AI usage tip — Draft the Cover Note and the Two-Track Regulatory Memo

**What the prompt does:** A Strategist ready to file the decree package needs a clear transmittal note and a memo that shows how the decree coordinates with the country's personal-data-protection law, so the data-protection authority backs the decree rather than challenging it. This prompt drafts both.
...
**Inputs and outputs:** Input: the country, the package contents, and the status of the personal-data-protection law. Output: a Cover Note and a Two-Track Regulatory Memo coordinating the decree with the data-protection law.

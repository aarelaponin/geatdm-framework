...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 5 — Title: 'gif-semantic-map — generate, then confirm'. Body, two text rows: 'Give Claude the published vocabulary and the two agencies' field lists; it drafts the mapping.' 'Every identifier and code value is a [confirm] until checked against the real registries — an invented mapping is confident and wrong.'" },
    { text: "The AI play is gif-semantic-map. Give Claude the published vocabulary and the two agencies' field lists, and it drafts the mapping — which field maps to which, where the code lists differ and need translating, which identifier to use as the link. That is the fast ninety per cent. The essential ten per cent is yours: every identifier and every code value is a [confirm] until you check it against the real registries. An invented mapping reads convincingly and is wrong — and in the semantic layer, wrong means a learner's records silently merged with someone else's. Generate fast; confirm against the registries carefully." },
  ...
  slideSpecRows: [
    ...
    ["5", "gif-semantic-map slide. Two text rows: generate, then [confirm] against registries.",
  ...
  aiTip: {
    title: "Generate a semantic map for an exchange (gif-semantic-map)",
    problem: "An architect needs a semantic map for one exchange — the entities, fields, code lists, identifier and the mapping onto published vocabularies — drafted from the two agencies' field lists. This is the gif-semantic-map play.",
...
body.push(...renderSubtopic({
  ...
  slideSpecRows: [
    ...
    ["3", "gif-openapi-gen slide. Two text rows: generate; [confirm] every field.",
      "Names the AI play and the anti-invention safeguard."],
  ...
  aiTip: {
    title: "Generate an OpenAPI service contract (gif-openapi-gen)",
    problem: "An architect needs an OpenAPI 3.x contract for a service, generated from the service brief and the semantic map, ready to derive an X-Road service description. This is the gif-openapi-gen play.",
...
body.push(...renderSubtopic({
  ...
  slideSpecRows: [
    ...
    ["4", "Three-layers-meet slide. Single text block tying legal, organisational, technical together.",
      "The synthesis across KP2's layers. Text-only."],
    ["5", "Single-sentence summary slide. One large text block (Arial Bold 28pt).",

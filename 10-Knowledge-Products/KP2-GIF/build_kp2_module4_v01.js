// Build KP2 Module 4 — Video Script Bundle v0.1
...
body.push(
  ...
  genericTable([700, 2700, 4700, 1600], ["#", "Title", "Single message", "Runtime"], [
    ...
    ["4.8", "Make the exchange lawful — the data-protection envelope",
      "Letters of Interest plus a data-protection envelope make a real exchange lawful as well as technically possible.", "~4 min"]
  ]),
  pageBreak()
);
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 4 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'Adopt the four-layer reference architecture, place every component in its layer, and the gaps show you what you still have to build.'" },
    ...
    { cue: "Slide 5 — Title: 'Sources'. Body: EU EIF / NIIS X-Road reference architecture (four functional layers); PAERA v1.0 §3.4.3. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
    ...
    ["3", "Map-components slide. Single text block on placing components and reading the gaps.",
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 3 — Title: 'What protects each crossing'. Body, three text rows: 'Between security servers: mutual TLS — both sides prove who they are.' 'The message itself is signed and logged — the X-Road message protocol.' 'The Trust-Anchor issues and can revoke the certificates.'" },
    ...
    { cue: "Slide 7 — Title: 'Sources'. Body: EU EIF / NIIS X-Road trust model (three zones); mTLS; the X-Road message protocol. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
    ...
    ["2", "Three-zones slide. Three text rows naming the zones.",
      "The model. Text-only."],
    ["3", "What-protects-each-crossing slide. Three text rows: mutual TLS, signed messages, the Trust-Anchor.",
...
body.push(...renderSubtopic({
  ...
  aiTip: {
    ...
    io: "Input: the country (and any standards already in use). Output: a standards-portfolio table plus the decisions that need deliberation.",
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 5 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'A lawful basis, a Letter of Interest, and data protection by design — the envelope that makes a wired exchange a lawful one.'" },
...
const doc = new Document({
  ...
  title: "KP2 Module 4 — Video Script Bundle v0.1 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP2 Topic 4 Script Bundle v0.1 · 27 June 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP2_Module4_Script_Bundle_v0.1.docx");

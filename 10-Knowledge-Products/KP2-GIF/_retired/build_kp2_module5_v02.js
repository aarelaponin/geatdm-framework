// Build KP2 Module 5 — Video Script Bundle v0.2
...
body.push(
  ...
  specTable([
    ...
    ["Version",             "v0.2 — aligned to ITU Knowledge Products and Video Materials Guide; Topic 6 folded in (12 September 2026)"],
...
const doc = new Document({
  ...
  title: "KP2 Module 5 — Video Script Bundle v0.2 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP2 Topic 5 Script Bundle v0.2 · 12 September 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP2_Module5_Script_Bundle_v0.2.docx");

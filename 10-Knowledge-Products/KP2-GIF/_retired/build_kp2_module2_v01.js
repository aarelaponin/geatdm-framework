// Build KP2 Module 2 — Video Script Bundle v0.1
...
body.push(
  ...
  genericTable([700, 2700, 4700, 1600], ["#", "Title", "Single message", "Runtime"], [
    ...
    ["2.5", "The Cover Note and Two-Track Regulatory Memo",
      "Give the Ministry of Justice the two routes to enactment, so the decree moves instead of sitting in a queue.", "~4 min"],
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { cue: "Slide 3 — Title: 'Each part has a different reader'. Body, three text rows: 'The minister reads the Memorandum.' 'The lawyer reads the Preamble and the Articles.' 'The decision-maker reads the Two-Track Memo to choose the instrument.'" },
    ...
    { text: "So the anatomy is five parts, each with a job and a reader: the Memorandum makes the case, the Preamble cites the authority, the Articles bind, the Cover Note transmits, and the Two-Track Memo frames the enactment choice. Knowing them is what lets you brief a Ministry of Justice with a near-complete package instead of waiting on one. This topic builds each part, component by component." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~5 min",
  words: 580,
  paeraAnchor: "Estonia Information Society Services Act; EU Once-Only Regulation; PAERA §5.2 #5 (Once-Only); national data-protection framework",
  ...
  slideSpecRows: [
    ["1", "Title slide. Title: 'The Draft Articles Package'.",
      "Standard ITU template. No images."],
    ["2", "Core-articles slide. Six text rows naming each operative article.",
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 480,
  paeraAnchor: "EU EIF (legal & governance layers); national legislative-process references",
  singleMessage: "Give the Ministry of Justice the two routes to enactment, so the decree moves instead of sitting in a queue.",
  scriptBeats: [
    { cue: "Slide 1 — Title: 'The Cover Note and Two-Track Regulatory Memo'. Voice-over begins." },
    { text: "You can have a perfect Memorandum, Preamble and set of Articles, and still watch the decree sit untouched in a Ministry of Justice queue for a year. The last two components of the kit exist to stop that. The Cover Note transmits the package clearly, and the Two-Track Regulatory Memo gives the decision-maker a real, framed choice about how to enact — so the answer is a decision, not a delay." },
    { cue: "Slide 2 — Title: 'The Cover Note'. Body, three text rows: 'What this package is, in three lines.' 'What is being asked of the Ministry of Justice, specifically.' 'The timeline, and the cost of slipping it.'" },
    ...
    { cue: "Slide 3 — Title: 'Two routes to enactment'. Body, two columns. Left 'Decree / regulation': 'Executive act — faster.' 'Lighter to amend later.' 'Force depends on existing enabling law.' Right 'Primary legislation': 'Through parliament — slower.' 'Strongest, most durable force.' 'Can create authority that does not yet exist.'" },
    { text: "The Two-Track Regulatory Memo lays out the choice honestly. One route is a decree or regulation — an executive act. It is faster, it is lighter to amend as the framework grows, but its force depends on an enabling law already existing. The other route is primary legislation — through parliament. It is slower, but it carries the strongest, most durable force, and it can create authority that does not yet exist in current law. Which route fits depends on your country's legal system and on how much force the mandatory-connection obligation needs to carry against a reluctant agency." },
    { cue: "Slide 4 — Title: 'Let the decision-maker choose with eyes open'. Body, single text block: 'The memo does not hide the trade-off — speed against durability and force. It frames the decision so it can be made quickly, by the person whose decision it is, rather than deferred because no one laid out the options.'" },
    { text: "The point of the memo is not to push one route. It is to frame the trade-off — speed against durability and legal force — so the decision can actually be made, quickly, by the person whose decision it is. Many interoperability efforts stall here, not because the answer is hard, but because no one laid the options out cleanly and the choice kept getting deferred. A decree that sits in a queue for a year is a framework that has not started. The kit's last job is to make the enactment decision easy to take." },
    { cue: "Slide 5 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'Transmit the package with a specific ask, and frame the decree-versus-legislation choice — so enactment is a decision, not a delay.'" },
    { text: "So the Cover Note and the Two-Track Memo are what carry a finished kit across the line. A specific ask that an official can act on, and a clean framing of the enactment choice that a decision-maker can settle in one meeting. With these, the package moves. What remains is to read the finished decree back against the framework, as configuration." },
    { cue: "Slide 6 — Title: 'Sources'. Body: EU European Interoperability Framework (legal & governance layers); national legislative-process references. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
    ["1", "Title slide. Title: 'The Cover Note and Two-Track Regulatory Memo'.",
      "Standard ITU template. No images."],
    ["2", "Cover Note slide. Three text rows: what it is, the specific ask, the timeline.",
      "The transmittal structure. Text-only."],
    ["3", "Two-routes slide. Two-column text: decree/regulation vs primary legislation, three rows each.",
      "The core comparison. Text columns, no icons."],
    ["4", "Eyes-open slide. Single text block on framing the trade-off for a quick decision.",
  ...
  aiTip: {
    title: "Draft the Cover Note and the two-track options memo",
    problem: "A Strategist ready to file the decree package needs a clear transmittal note and a balanced decree-versus-legislation memo for the decision-maker. This prompt drafts both.",
    ...
    io: "Input: the country and the package contents. Output: a Cover Note and a balanced two-track enactment memo.",
...
const doc = new Document({
  ...
  title: "KP2 Module 2 — Video Script Bundle v0.1 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP2 Topic 2 Script Bundle v0.1 · 27 June 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP2_Module2_Script_Bundle_v0.1.docx");

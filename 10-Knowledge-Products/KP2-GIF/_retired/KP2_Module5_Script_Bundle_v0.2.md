<!-- GENERATED from build_kp2_module5_v02.js by bundle_to_md.py — do not hand-edit; edit the build script and regenerate. -->

# KP2 Module 5 — Video Script Bundle v0.2 (ITU-aligned)
...
### 5.6 Corrections still pending from the 10 September script-vs-pack review

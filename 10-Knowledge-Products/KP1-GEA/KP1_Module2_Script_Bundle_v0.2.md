<!-- GENERATED from build_kp1_module2_v02.js by bundle_to_md.py — do not hand-edit; edit the build script and regenerate. -->

# KP1 Module 2 — Video Script Bundle v0.2 (ITU-aligned)
...
**On-screen practice box (recap slide, not narrated):** **Do this on your own sector.** Run the prompt in the description on your own ministry — it gives you a four-section capture template ready to take into Discovery interviews. Before the next video.
...
**On-screen practice box (recap slide, not narrated):** **Do this on your own sector.** Run the prompt in the description on your own ministry — it gives you a mapping table plus lists of non-conforming elements, missing relationships, and suggested corrections. Before the next video.
...
**On-screen practice box (recap slide, not narrated):** **Do this on your own sector.** Run the prompt in the description on your own ministry — it gives you a four-part principle card ready for the EA Board's principle register. Before the next video.
...
**On-screen practice box (recap slide, not narrated):** **Do this on your own sector.** Run the prompt in the description on your own ministry — it gives you a classification, an expected-profile table, and confirmation questions. Before the next video.
...
> _Slide 6 — Title: 'In one sentence'. Body, vertical stack (Arial Bold 28pt): 'Service: sit an examination, get a certificate → Capability: run-an-examination, certify-a-result (PNEA) → Application: exam-management system → Data: learner, person, result → Technology: data exchange, identity platform.'_
...
> _Slide 7 — Title: 'Sources'. Body: PAERA v1.0 Annex 2 (Metamodel); §5.2 (Principles — once-only). Footer: 'Find the link in the description.'_
...
| 6 | Single-sentence summary slide. Vertical text-box stack (Arial Bold 28pt) from service to technology. | The centrepiece visual doubles as the take-home line — the full four-layer thread on one fictional service. Text-box connectors only. |
| 7 | Sources slide. Footer: 'Find the link in the description.' | Lets viewers verify the metamodel and once-only references. |

**On-screen practice box (recap slide, not narrated):** **Do this on your own sector.** Run the prompt in the description on your own ministry — it gives you a five-section BDAT skeleton with conflicts flagged. Before the next video.
...
**On-screen practice box (recap slide, not narrated):** **Do this on your own sector.** Run the prompt in the description on your own ministry — it gives you a scored gap table, per-layer maturity scores, and the top-three priority gaps with rationale. Before the next video.
...
**On-screen practice box (recap slide, not narrated):** **Do this on your own sector.** Run the prompt in the description on your own ministry — it gives you a two-trap screen, questions for the project team, and a recommended sourcing posture. Before the next video.

// Build KP1 Module 4 — Video Script Bundle v0.2
...
body.push(
  ...
  genericTable([700, 2900, 4500, 1600], ["#", "Title", "Single message", "Runtime"], [
    ["4.1", "Meet Progressa — a real sector with a real fragmentation problem",
      "Progressa is a demonstration education sector with the fragmentation problem most countries share — the same learner registered several times, identity proven on paper. It is the canvas the whole method runs on.", "~3 min"],
    ["4.2", "Phase 1, Discover — map what the sector has today",
      "Discover produces one honest picture of what the sector has today — described, not judged — signed off as accurate before any analysis begins.", "~4 min"],
    ["4.3", "Phase 2, Assess — find the gaps and rank them",
      "Assess turns Progressa's picture into a ranked gap analysis — the right problems in the right order, signed off as ground truth, including the uncomfortable ones.", "~3 min"],
    ["4.4", "Phase 3, Adapt — fit PAERA and decide build, buy or share",
      "Adapt fits PAERA to Progressa — localised principles and a deliberate build, buy, share or sandbox call for every building block — with reuse as the default that build must justify against.", "~3 min"],
    ["4.5", "Phase 4, Plan — design the target architecture",
      "Between the gaps and the roadmap sits the deliverable the whole EA is for — the target architecture: future-state capabilities, one owner per data domain, shared platforms and the integration map, reached by applying your principles to the gaps.", "~4 min"],
    ["4.6", "Phase 4, Plan — sequence the roadmap and cost it",
      "Plan turns the decisions into a wave-sequenced, costed roadmap — the cabinet-ready document business and IT both read — with the minister's flagship landing inside the first year.", "~4 min"],
    ["4.7", "Phase 5, Execute & Govern — stand up the living EA",
      "Execute & Govern makes the architecture live — a repository kept true, a Board that enforces re-use at the gate (catching a project's fourth learner list before it is built), and the rhythm where business and IT keep deciding together.", "~3 min"],
...
body.push(...renderSubtopic({
  ...
  runtime: "~3 min",
  words: 340,
  practice: "a one-page canvas (bodies, symptoms, stalled flagship)",
  ...
  scriptBeats: [
    ...
    { text: "To see the method work, you need a realistic place to run it. Progressa is a demonstration country with an education sector like many across the continent — real institutions, a real fragmentation problem, and a minister who wants results." },
    ...
    { text: "Progressa is fictional on purpose: it shows every step without exposing any real country, and its shapes — duplicate registries, paper re-entry, a stalled flagship — are the ones you will recognise. At each step, ask what the equivalent would be in your own sector." },
    ...
    { text: "So this is Progressa. A realistic education sector, five institutions, and the fragmentation problem most countries live with — the canvas the whole method runs on." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 385,
  practice: "a Discovery brief outline with capture questions, a source column and the sign-off question",
  ...
  scriptBeats: [
    ...
    { text: "The first phase is Discover. One question: what exists today? Not what is wrong — that comes later. An accurate picture of where the sector is now. On Progressa, Discovery takes about three to four weeks and produces a single deliverable: the Discovery brief." },
    ...
    { text: "That is Phase 1 on Progressa. One question — what exists today. One deliverable — the Discovery brief. One discipline — describe, do not recommend. One sign-off — the picture is accurate." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~3 min",
  words: 335,
  practice: "capability maturity scores, a ranked gap table, and the honesty flags",
  ...
  scriptBeats: [
    ...
    { text: "Phase two is Assess. Now you judge: what is the gap between where Progressa is and where it needs to be? The deliverable is the current state in four layers, maturity scorecards, and a gap analysis that ranks the problems. About six to eight weeks." },
    ...
    { text: "On Progressa the duplicate learner registry tops the list. It is the direct cause of the minister's stalled single-learner-record promise, it burdens every parent, and it is closable by making the Learner Registry authoritative and having the others consume it. The no-data-exchange gap is high impact but harder, so it sequences later." },
    ...
    { text: "That is Phase 2 on Progressa. Score the capabilities. Name the four gaps. Rank by impact where movement is possible. Sign it off as honest ground truth — including the uncomfortable one." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~3 min",
  words: 360,
  practice: "a build/buy/share/sandbox matrix with flags",
  ...
  scriptBeats: [
    ...
    { text: "Phase three is Adapt. PAERA is a starting point, not a constraint, so now the architects shape it to Progressa — its own principles, its sector priorities, and a sourcing decision for each building block. About four to six weeks." },
    ...
    { text: "Notice the pattern in those calls. The default is reuse and share; build is the exception that must justify itself. This is the phase where the whole-of-government saving is actually chosen — a procurement rule could not make these calls, only an architect looking across the whole sector." },
    ...
    { text: "That is Phase 3 on Progressa. Localise the principles. Make a deliberate sourcing call for each building block, with reuse as the default. Sign off the framework and the matrix. Four to six weeks." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 475,
  practice: "a first-cut target architecture in four layers, an integration map",
  ...
  scriptBeats: [
    ...
    { text: "Between where Progressa is today and how it gets somewhere sits the deliverable the whole architecture exists to produce: the target architecture, the picture of the future state you are building toward. Skip it, and you sequence a roadmap to a destination nobody drew." },
    ...
    { text: "So before you sequence anything, design the target: the future-state picture in four layers plus the integration map, reached by applying your principles to the gaps you found, every element traceable to a sourcing decision." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 385,
  practice: "a four-wave roadmap with deliverables, dependencies and cost drivers",
  ...
  scriptBeats: [
    ...
    { text: "Phase four is Plan. Now the decisions become a sequence: how does Progressa get from today to the target, in what order, at what cost? The deliverable is a roadmap in waves with investment estimates. About six to eight weeks." },
    ...
    { text: "The roadmap does a second job: it is the one page the business side and the IT side both point at — the minister reading outcomes and dates, the architects reading the sequence and its dependencies — so the policy goal and the technical sequence line up without translation." },
    ...
    { text: "That is Phase 4 on Progressa. Sequence into waves, each delivering something visible. Cost each wave honestly. Put the minister's promise in an early wave. Sign off the roadmap and commit the budget." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~3 min",
  words: 345,
  practice: "answered gate questions, a recommended ruling, and a decision-log entry",
  ...
  scriptBeats: [
    ...
    { text: "Phase five is Execute and Govern — the phase that never ends. The approved roadmap becomes a project pipeline, and a small permanent EA team turns it into a living practice. Three things make it real on Progressa: the repository, the Board, the review gate." },
    ...
    { cue: "Slide 5 — Title: 'In one sentence'. Body, large text (Arial Bold 28pt): 'Execute & Govern makes the architecture live — a repository kept true, a Board that enforces re-use at the gate, and the standing rhythm where business and IT keep deciding together.'" },
    { text: "That is Phase 5 on Progressa. The repository live and current. The Board binding. The gate catching the fourth learner list before it is built. The business and IT sides deciding together, quarterly, forever." },
    { cue: "Slide 6 — Title: 'Sources'. Body: PAERA v1.0 §4.2.1 Management; §4.2.2 Architecture; §5.4 Organisational Assessment & Roadmap. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
    ...
    ["4", "Board-enforces-re-use slide. Single text block, closing on the quarterly rhythm.",
      "Carries the planning-enables-re-use argument home as the Progressa punchline, and the lingua-franca argument in its closing sentence. The pivotal slide."],
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 385,
  practice: "a one-page transfer plan (classification, the high-priority use case, the six deliverables, the first two waves)",
  paeraAnchor: "§5.4 Organisational Assessment & Roadmap; §5.7 Recommended Roadmap",
  ...
  scriptBeats: [
    ...
    { text: "The value of a worked example is not Progressa itself — it is that the same five phases, four sign-offs and six deliverables run on any public-sector domain you are handed. Here is the recipe, stripped to what transfers." },
    ...
    { text: "The recipe: five phases, four sign-offs, six deliverables, reuse before build, a Board that can say no. Change the institutions and the domains, keep the method, and it runs on any sector you are handed." },
    { cue: "Slide 7 — Title: 'Sources'. Body: PAERA v1.0 §5.4 Organisational Assessment & Roadmap; §5.7 Recommended Roadmap. Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
...
const doc = new Document({
  ...
  title: "KP1 Module 4 — Video Script Bundle v0.2 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP1 Topic 4 Script Bundle v0.2 · 3 September 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP1_Module4_Script_Bundle_v0.2.docx");

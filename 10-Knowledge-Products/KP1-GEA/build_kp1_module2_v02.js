// Build KP1 Module 2 — Video Script Bundle v0.2
...
body.push(
  ...
  specTable([
    ...
    ["Version",             "v0.2 — tightened per the KP1 length-discipline pass of September 2026; first Architect-facing module, aligned to ITU Knowledge Products and Video Materials Guide"],
...
body.push(...renderSubtopic({
  ...
  practice: "a four-section capture template ready to take into Discovery interviews",
  ...
  scriptBeats: [
    ...
    { text: "An Enterprise Architecture describes a government in four layers: Business, Data, Application, Technology. For each layer you need three things — the question it answers, the deliverable you produce, and the mistake that catches first-time architects." },
...
body.push(...renderSubtopic({
  ...
  practice: "a mapping table plus lists of non-conforming elements, missing relationships, and suggested corrections",
  ...
  scriptBeats: [
    ...
    { text: "Two ministries each hand you an architecture. One calls a thing a 'service'; the other calls the same thing a 'function'. One ministry's 'application' is another's 'system'. You cannot compare them, connect them, or tell whether they are doing the same work twice." },
    ...
    { text: "You do not design the metamodel: PAERA publishes it in Annex 2, already worked out across many countries, so you adopt it from day one and extend it only where your country genuinely needs an entity PAERA does not have — deliberately, and written down so every team shares it." },
    ...
    { text: "The metamodel is the small shared dictionary that lets two ministries' architectures fit together, and lets business and IT understand each other — what turns re-use from a wish into a plan." },
...
body.push(...renderSubtopic({
  ...
  practice: "a four-part principle card ready for the EA Board's principle register",
  ...
  scriptBeats: [
    ...
    { text: "Every architecture team faces the same temptation early on. Someone says: let us write our country's architectural principles. Three months later there are forty drafts, half contradicting each other, and no agreement. There is a faster way — the principles already exist." },
    ...
    { text: "Do not spend your first year writing principles. Adopt PAERA's ten, point each at your country's laws, and give each a written implication so it can settle a real argument." },
...
body.push(...renderSubtopic({
  ...
  practice: "a classification, an expected-profile table, and confirmation questions",
  ...
  scriptBeats: [
    ...
    { text: "Before you model a government body, know what kind of body it is — because the kind tells you in advance what it does, what data it owns, and how it is governed. PAERA publishes a taxonomy that sorts public bodies into a few types." },
    ...
    { text: "Before you model, classify. Policy unit, regulatory agency, service-delivery authority, plus registries and shared platforms. Each type carries an expected profile of capabilities, data and governance — so the interview confirms it instead of starting blank." },
...
body.push(...renderSubtopic({
  ...
  practice: "a five-section BDAT skeleton with conflicts flagged",
  ...
  scriptBeats: [
    ...
    { text: "Put the four layers on a real sector. Progressa is a demonstration country with an education system like many across the continent: a ministry, an examination authority, a learner registry, an identity authority, and a digital government authority running shared platforms." },
    ...
    { cue: "Slide 6 — Title: 'In one sentence'. Body, vertical stack (Arial Bold 28pt): 'Service: sit an examination, get a certificate → Capability: run-an-examination, certify-a-result (PNEA) → Application: exam-management system → Data: learner, person, result → Technology: data exchange, identity platform.'" },
    { text: "Trace one service down. Sit an examination and get a certificate: the Examination Authority's run-an-examination capability, the exam-management application, three data domains — learner, person, result — and the shared data-exchange and identity platforms underneath." },
    { cue: "Slide 7 — Title: 'Sources'. Body: PAERA v1.0 Annex 2 (Metamodel); §5.2 (Principles — once-only). Footer: 'Find the link in the description.'" }
  ],
  slideSpecRows: [
    ...
    ["6", "Single-sentence summary slide. Vertical text-box stack (Arial Bold 28pt) from service to technology.",
      "The centrepiece visual doubles as the take-home line — the full four-layer thread on one fictional service. Text-box connectors only."],
    ["7", "Sources slide. Footer: 'Find the link in the description.'",
...
body.push(...renderSubtopic({
  ...
  practice: "a scored gap table, per-layer maturity scores, and the top-three priority gaps with rationale",
  ...
  scriptBeats: [
    ...
    { text: "The Assess phase produces the current-state picture and the gap analysis the roadmap is built on. The hard part is writing a description good enough to decide from. So you need the quality tests, layer by layer, and the gaps you will almost always find." },
    ...
    { text: "A Phase 2 Assess is not about volume. It is a current-state picture that is owned, traceable and complete enough to decide from, plus a gap analysis that scores and orders the problems honestly." },
...
body.push(...renderSubtopic({
  ...
  practice: "a two-trap screen, questions for the project team, and a recommended sourcing posture",
  ...
  scriptBeats: [
    ...
    { text: "Two traps catch governments again and again. As the architect at the Assess phase, you are the one positioned to spot them early — before they are built, while they are still a line in a project plan." },
    ...
    { text: "Watch for the two traps. The bespoke trap — rational for a project, ruinous for a country. And the vendor-driven trap — where a product becomes the architecture. Both are cheap to fix at Assess." },
...
const doc = new Document({
  ...
  title: "KP1 Module 2 — Video Script Bundle v0.2 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP1 Topic 2 Script Bundle v0.2 · 3 September 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP1_Module2_Script_Bundle_v0.2.docx");

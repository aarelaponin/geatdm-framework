// Build KP1 Module 3 — Video Script Bundle v0.2
...
body.push(
  ...
  genericTable([700, 2900, 4500, 1600], ["#", "Title", "Single message", "Runtime"], [
    ["3.1", "Set up the one place your architecture lives",
      "An EA repository is the single agreed place the architecture lives — the layers, the relationships and the decisions — so there is one picture of your government, not many private copies.", "~4 min"],
    ...
    ["3.4", "Stand up an EA Board that can actually say no",
      "An EA Board with binding authority — the right chair and members, and a cadence that doesn't block delivery — is what turns the architecture into the place every digital decision passes through.", "~4 min"],
    ["3.5", "Review projects against the architecture",
      "A short, consistent set of questions every project answers before funding — with logged decisions and time-boxed exceptions — is what turns re-use from a wish into the default path.", "~4 min"],
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 445,
  practice: "a repository schema plus single-source rules",
  ...
  scriptBeats: [
    ...
    { text: "You have the four-layer picture of a sector. Where does it live? If the answer is a slide deck on your laptop, the architecture will be out of date within a month and disagreed with within two. It needs a home: the repository." },
    ...
    { text: "The repository is also the object both sides point at: when the minister briefs cabinet and the architect designs a system they are looking at the same picture, which is what makes the architecture a shared language between the business side and the IT side instead of two private ones." },
    ...
    { text: "So before tooling, before governance, set up the one place — the single store of the layers, the relationships and the decisions. Let copies multiply, and no amount of governance will save the architecture." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 395,
  practice: "a scored comparison table plus a recommendation",
  ...
  scriptBeats: [
    ...
    { text: "At some point a spreadsheet stops coping — hundreds of entities, several sectors, relationships you cannot see in rows and columns. Here is the danger: in buying a tool to help your government avoid vendor lock-in, you can lock yourself into the tool." },
    ...
    { text: "Choose your tooling like any government system: graduate when the spreadsheet truly hurts, reuse before buy, buy before build, keep your content in open formats you control, and bend the tool to your metamodel." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 435,
  practice: "a one-page update policy",
  ...
  scriptBeats: [
    ...
    { text: "A repository has one enemy, and it is not technical. It is staleness. An architecture six months behind reality is worse than none — because people trust it, and it lies to them. Keeping it true is unglamorous and constant." },
    ...
    { text: "Keep the repository true. One named owner. Updates triggered by events, not a yearly review. A light conformance check. Neglect it, and within a year you have a widely-trusted work of fiction." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 510,
  practice: "a structured EA Board Terms of Reference",
  ...
  scriptBeats: [
    ...
    { text: "The repository holds the architecture; the Board is what gives it authority. Without a governance board the architecture is a document people can ignore. With a real one — that can say no — it becomes the place every significant digital decision passes through." },
    ...
    { text: "Stand up a Board that can say no: binding, not advisory, chaired by someone senior enough that the no sticks, made of the people whose systems are affected, on a rhythm that governs without blocking." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 410,
  practice: "an intake checklist, pass criteria, exception form and decision-log fields",
  ...
  scriptBeats: [
    ...
    { text: "A Board with authority needs something to do with it: the architecture review gate, where every significant new project passes through a short, consistent set of questions before it gets funded. This is where the architecture does its real work." },
    ...
    { text: "So build the gate. A few questions, asked of every project the same way. A clear ruling — consume the shared block, or a written, time-boxed exception. Every decision logged with its reason." },
...
body.push(...renderSubtopic({
  ...
  runtime: "~4 min",
  words: 415,
  practice: "a one-page scorecard template with metrics, computations and thresholds",
  ...
  scriptBeats: [
    ...
    { text: "Sooner or later your minister asks the fair question: is this EA work actually doing anything? You need an answer that is honest, short and true — a handful of metrics, not a fifty-page report. Pick them carefully." },
    ...
    { text: "So measure a few things, honestly. Coverage. Re-use rate. Open exceptions. Decisions made and how fast. On one page, every quarter, amber where they should be amber." },
...
body.push(...renderSubtopic({
  ...
  scriptBeats: [
    ...
    { text: "Most EA programmes do not fail dramatically. They fade. The first six months go well; then, somewhere in the second year, the practice quietly stops mattering. The fade is predictable, and it comes in four forms." },
    ...
    { text: "Watch for the four fades — the team pulled, the repository stale, the Board gone advisory, the sponsor changed — and counter each. Keep the practice alive past year two, and the architecture becomes how government works." },
...
const doc = new Document({
  ...
  title: "KP1 Module 3 — Video Script Bundle v0.2 (ITU-aligned)",
  ...
  sections: [{
    ...
    headers: { default: new Header({ children: [new Paragraph({ alignment: AlignmentType.RIGHT,
      children: [new TextRun({ text: "FiscalAdmin OÜ — ITU/Giga · KP1 Topic 3 Script Bundle v0.2 · 3 September 2026",
...
Packer.toBuffer(doc).then(buf => {
  const out = process.env.OUT_PATH || path.join(__dirname, "KP1_Module3_Script_Bundle_v0.2.docx");

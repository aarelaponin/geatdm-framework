#!/usr/bin/env python3
# Build the KP1 Module 6 (Topic 6) video deck on the ITU template.
...
def section(code, name, message, runtime, note):
    return section_slide(prs, 'KP1 · MODULE 6 · VIDEO %s' % code, code, name, message,
...
edit_cover(
    ...
    kicker='KP1 · Government Enterprise Architecture · Module 6',
    ...
    length='~33 mins across 7 videos (6.1 – 6.7)',
    audience=AUDIENCE,
...
edit_agenda(
    prs,
    header='Module 6 — seven videos',
    items=[
        ('6.1  Is this proven? Evidence from real programmes', '~5 min'),
        ('6.2  What works, and what quietly kills them', '~5 min'),
        ('6.3  Will it work for your other sectors?', '~5 min'),
        ('6.4  Win the commitment — the business case', '~5 min'),
        ('6.5  Build capability with open knowledge products', '~4 min'),
        ('6.6  Roll it out to a national EA practice', '~4 min'),
        ('6.7  The closing case — proven, portable, necessary', '~5 min'),
    ],
    message_paras=[
    ...
    note_text='Navigation slide for the combined deck; the videos ship standalone on YouTube. '
              '6.1 and 6.2 are the evidence — what four governments built, and what makes these '
              'programmes live or die. 6.3 is the portability case. 6.4 to 6.6 are the '
              'commitment, the capability and the rollout. 6.7 puts the whole case in one piece.')

delete_template_slides(prs, keep=2)


# ================================================================ 6.1
T = '6.1 · Is this proven, or just theory? — evidence from real programmes'
section('6.1', 'Is this proven, or just theory? — evidence from real programmes',
...
# ================================================================ 6.2
T = '6.2 · What the evidence says works — and what quietly kills these programmes'
section('6.2', 'What the evidence says works — and what quietly kills these programmes',
...
# ================================================================ 6.3
T = '6.3 · Will it work for your other sectors? — the portability case'
section('6.3', 'Will it work for your other sectors? — the portability case',
...
# ================================================================ 6.4
T = '6.4 · Win the commitment — the business case that gets your minister to yes'
section('6.4', 'Win the commitment — the business case that gets your minister to yes',
...
# ================================================================ 6.5
T = '6.5 · Build your team\'s capability with open knowledge products'
section('6.5', 'Build your team\'s capability with open knowledge products',
...
# ================================================================ 6.6
T = '6.6 · Roll it out — from one sector to a national EA practice'
section('6.6', 'Roll it out — from one sector to a national EA practice',
...
# ================================================================ 6.7
T = '6.7 · The closing case — proven, portable, and necessary now'
section('6.7', 'The closing case — proven, portable, and necessary now',
...
OUT = os.environ.get('OUT_PATH') or os.path.join(
    ...
    'videos', 'module_6', 'en', 'decks', 'KP1_M6_Deck_v0.1.pptx')
prs.save(OUT)

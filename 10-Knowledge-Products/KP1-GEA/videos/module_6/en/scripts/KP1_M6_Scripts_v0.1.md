# KP1 Module 6 (Topic 6) — Voice-over scripts
...
## 6.1 Is this proven, or just theory? — evidence from real programmes (~5 min)
...
## 6.2 What the evidence says works — and what quietly kills these programmes (~5 min)
...
## 6.5 Build your team's capability with open knowledge products (~4 min)
...
## 6.6 Roll it out — from one sector to a national EA practice (~4 min)
...
## 6.7 The closing case — proven, portable, and necessary now (~5 min)

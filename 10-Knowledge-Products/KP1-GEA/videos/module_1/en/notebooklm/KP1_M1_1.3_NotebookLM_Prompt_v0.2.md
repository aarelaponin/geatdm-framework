...
Deck `KP1_M1_1.3_Deck_v0.2.pptx` · brief `KP1_M1_1.3_AudioBrief_v0.2.md`
...
3. Add `KP1_M1_1.3_AudioBrief_v0.2.md` as the **only** source.
...
```
Follow the source "AUDIO BRIEF — KP1 Module 1 Video 1.3" exactly, working through its

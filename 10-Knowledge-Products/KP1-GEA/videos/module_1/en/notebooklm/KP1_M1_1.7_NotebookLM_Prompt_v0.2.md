...
Say "PAERA" as a name; do not expand it unless the brief does, and if you do, the only expansion is "Public Administration Ecosystem Reference Architecture". "register" not "registry", "building block" — never "module" or "component". Invent no figures, dates, countries or examples.
```

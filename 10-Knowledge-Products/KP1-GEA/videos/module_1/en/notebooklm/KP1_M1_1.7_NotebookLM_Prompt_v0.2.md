...
Say "the reference architecture" in words; never say the initialism "PAERA" or any expansion of it. "register" not "registry", "building block" — never "module" or "component". Invent no figures, dates, countries or examples.
```

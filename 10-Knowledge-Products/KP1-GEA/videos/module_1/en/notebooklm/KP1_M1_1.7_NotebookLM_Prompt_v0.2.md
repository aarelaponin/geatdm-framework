...
Deck `KP1_M1_1.7_Deck_v0.2.pptx` · brief `KP1_M1_1.7_AudioBrief_v0.2.md`
...
3. Add `KP1_M1_1.7_AudioBrief_v0.2.md` as the **only** source.
...
Say "PAERA" as one word — five letters, P-A-E-R-A, never spelled out on air — as a name; do not expand it unless the brief does, and if you do, the only expansion is "Public Administration Ecosystem Reference Architecture". "register" not "registry", "building block" — never "module" or "component". Invent no figures, dates, countries or examples.
```

## Step 4 — Fallback if the box truncates

```
Follow the source "AUDIO BRIEF — KP1 Module 1 Video 1.7" exactly, working through its

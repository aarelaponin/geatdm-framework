...
| Word budget | **about 535 spoken words in total.** Overruns are almost always words, not pace — cut words per segment rather than speaking faster |
...
### Slide 2 — The pattern · 0:15–0:55 (40 s · ~90 words)

Content, all of it, nothing more:

- One programme builds a system to register citizens. Another builds another, for a different
  service. A third builds a third. Each takes years, and each is funded separately.
- The citizen still fills the same form five times, at five different counters.
- **The key insight, stated plainly by Host B:** you cannot fix this inside any one programme.
  Each programme is doing exactly what it was funded to do.

Host A may ask **one** short clarifying question here. Not more.

### Slide 3 — Four signs your government has no shared plan · 0:55–2:20 (85 s · ~200 words)

The deck reveals these one at a time, cumulatively. Host A opens with the retrieval question,
then **a full two-second pause before Host B answers**:

> "Before we go through them — how many separate registers of the same citizens does your
> government keep? Hold that number."

Then **number the signs out loud — "sign one", "sign two", "sign three", "sign four"** — about
20 seconds each, in this order:

1. **More than one register of the same people.** The school list has one. The national ID
   register has another. The social register has a third. Each has its own list. None of them
   agree.
2. **Every system-to-system link is built from scratch.** Last year your team connected the tax
   office to the business register. This year the same work again, for the health ministry. The
   connection is built again, from zero.
...
### Slide 4 — The country pays in four directions at once · 2:20–3:05 (45 s · ~100 words)

Name all four aloud, in this order, about 11 seconds each:
...
**Land the fourth one hardest.** The deck highlights that cell deliberately: it is the cost that
moves this audience. Host B slows down and lets it sit for a beat before the next slide.

### Slide 5 — "In one sentence": one root cause, there is no shared plan · 3:05–3:50 (45 s · ~100 words)

This is the most important slide in the video. Give it room; do not rush it.
...
- The rest of this knowledge product shows how to commission one, what it delivers, and what you
...
Say the single message once, then stop. No restatement of the four signs, no invitation to act.

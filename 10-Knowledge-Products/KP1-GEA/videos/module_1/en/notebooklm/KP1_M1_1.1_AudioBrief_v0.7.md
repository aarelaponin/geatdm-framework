...
### Slide 1 — 1.1 — Why your country needs a national EA · 0:00–0:15 (15 s · ~0 words of substance)
...
### Slide 2 — Why your country needs a national EA · 0:15–0:59 (44 s · ~64 words of substance)
...
### Slide 3 — Four signs your government has no shared plan · 0:59–3:14 (135 s · ~197 words of substance)
**The substance. Every sentence the hosts say in this segment comes from these words — discuss them, do not depart from them:**
...
- More than one register of the same people The school list has one. The national ID register has another. The social register has a third. None of them agree.
- Every system-to-system link built from scratch Last year your team connected the tax office to the business register. This year, the same work again — for the health ministry.
- Vendor lock-in on systems built years ago One vendor built it ten years ago. To change anything, you call that vendor and pay what they ask. The vendor knows this, and prices accordingly.
- Ministries that do not connect across each other The citizen who gave her ID number to the health ministry gives it again, on paper, when she enrols her child in school. “Ask once” exists on paper only.

**Staging:** Rows reveal one at a time, cumulative.

**Staging:** RETRIEVAL MOMENT (before revealing row 1): ask the viewer — how many separate registers of the same citizens does your government keep? Hold two seconds, then reveal.

### Slide 4 — The country pays in four directions at once · 3:14–4:02 (48 s · ~71 words of substance)
**The substance. Every sentence the hosts say in this segment comes from these words — discuss them, do not depart from them:**
...
### Slide 5 — One root cause: there is no shared plan · 4:02–4:50 (48 s · ~71 words of substance)
...
**Staging:** This is the most important slide of video 1.1 — hold it a beat longer.

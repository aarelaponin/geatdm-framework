...
Say "PAERA" (spelled P-A-E-R-A on first mention), "register" not "registry", "building block" — never "module" or "component". Invent no figures, dates, countries or examples.
```

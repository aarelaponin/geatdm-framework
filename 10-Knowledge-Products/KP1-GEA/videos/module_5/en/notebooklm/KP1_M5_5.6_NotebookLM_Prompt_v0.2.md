# NotebookLM setup for KP1 · M5 · Video 5.6

Deck `KP1_M5_5.6_Deck_v0.2.pptx` · brief `KP1_M5_5.6_AudioBrief_v0.2.md`
...
3. Add `KP1_M5_5.6_AudioBrief_v0.2.md` as the **only** source.
...
```
Follow the source titled "AUDIO BRIEF — KP1 Module 5 Video 5.6" exactly. It is the sole
...
```
Follow the source "AUDIO BRIEF — KP1 Module 5 Video 5.6" exactly, working through its
...
python3 …/kp-audio-brief/scripts/srt_drift_check.py \
  videos/module_5/en/audio/KP1_M5_5.6_Audio_v0.X.srt --target 300 --tolerance 45
```

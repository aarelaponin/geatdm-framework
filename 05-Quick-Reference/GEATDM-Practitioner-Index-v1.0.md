...
### 6.4 Regulatory Agency Sector (RA)
...
│   ├── GEATDM-Practitioner-Index-v1.0.md   ← THIS DOCUMENT
│   └── GEATDM-Input-Preprocessing-v1.0.md  ← Input framework
│
└── 06-Sector-Guides/                        ← NEW: Sector-specific
    ├── GEATDM-Sector-Customs-v1.0.md
    ├── GEATDM-Sector-Tax-v1.0.md
    └── GEATDM-Sector-SocialSecurity-v1.0.md
```
...
| Quick reference during engagement | 05-Quick-Reference/Practitioner-Index |
| Preprocess customer documents | 05-Quick-Reference/Input-Preprocessing |

...
### 9.1 Minimum Viable Input Set

For a basic engagement, you need at minimum:

| Category | Minimum Documents |
|----------|-------------------|
| _as-is/ | Organization chart, system inventory, 1 process example |
| _international/ | Primary sector standard (e.g., WCO for customs) |
| _practical-experience/ | Capability model for sector |

### 9.2 Ideal Input Set

For a comprehensive engagement:

| Category | Ideal Documents |
|----------|-----------------|
| _as-is/ | Full EA assessment, process inventory, integration diagram, infrastructure doc |
| _international/ | Sector standards, IMF/WB guidance, regional requirements |
| _practical-experience/ | Capability model, process templates, data models, functional examples |

---

## 10. Appendix: Sample Preprocessing for Lesotho Customs
...
cu_ea_prj/
├── _as-is/
│   └── ea-findings-BDAT-v3.docx    # Gambia template (adapt for Lesotho)
│
├── _international/
...
│
└── _results/
    └── lesotho-customs-ta-approach.md
```
